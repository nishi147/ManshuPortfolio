  ...
  return (
    <div className="course-detail-page fade-in">
      <div className="course-hero">
        <div className="container course-detail-centered">
          <div className="course-info centered">
             <span className="category-badge">{course.category}</span>
             <h1>{course.title}</h1>
             
             <div className="course-stats-mini centered">
          ...
          <div className="course-video-full-width">
            <div className="full-width-video-wrapper glass-panel">
              {course.demoVideo ? (
                ...
                <img src={course.thumbnail} alt={course.title} className="full-width-thumbnail" />
              ) : (
                <div className="placeholder-img full-width-placeholder">No Preview Available</div>
              )}
            </div>
          </div>

          <div className="course-detail-actions centered">
